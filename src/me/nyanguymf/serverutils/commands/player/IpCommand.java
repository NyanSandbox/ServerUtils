...
class IpCommand extends Command {
    ...
    public IpCommand(String permission, String command, MessagesManager mm) {
    ...
    public void execute(CommandSender sender, boolean permission, Player player) {
        ...
        String format = super.mm.getColoredMessage("player.stats.ip");
        String ip     = player.getAddress().getAddress().getHostAddress();

        sender.sendMessage(StringUtils.replaceVariable(format, ip));
    }
}
